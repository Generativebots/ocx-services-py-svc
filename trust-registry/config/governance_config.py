...
DEFAULT_GOVERNANCE_CONFIG: Dict[str, Any] = {
    ...
    # AOCS — LLM API Keys (tenant-specific, fallback to env vars)
    "openai_api_key": "",
    "anthropic_api_key": "",
    "gemini_api_key": "",

    # AOCS — Cognitive Auditor Preferences
    "llm_intent_extraction": False,
    "default_juror_priority": "openai",  # "openai", "anthropic", "gemini"
